...
public final class FlightStatsDemoConfig extends Config {
    ...
    public FlightStatsDemoConfig() throws JSONException {
        this.databaseDemo = createDatabase();
    ...
    private JSONObject createDatabase() throws JSONException {
        return new JSONObject(readDatabase());
    }
